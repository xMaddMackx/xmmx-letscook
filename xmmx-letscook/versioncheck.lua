Citizen.CreateThread( function()
    updatePath = "/xMaddMackx/xmmx-letscook" -- your git user/repo path
    resourceName = "xmmx-letscook ("..GetCurrentResourceName()..")" -- the resource name
    ...
    function checkVersion(err,responseText, headers)
        ...
        if curVersion ~= responseText and tonumber(curVersion) < tonumber(responseText) then
            print("\n###############################")
            print("\n"..resourceName.." is outdated, should be:\n"..responseText.."is:\n"..curVersion.."\nplease download the update from keymaster.")
            print("\n###############################")
